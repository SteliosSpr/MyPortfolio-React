		...
		<Router>
			<div app-container>
				...
				<Routes>
					...
					/>
					<Route
						path="/MyPortfolio-React/gameBay"
						element={
							<ProjectInformation
								projectName="Game Bay"
								projectGitHubLink="https://github.com/SteliosSpr/Game-Angular"
								imagePath="/MyPortfolio-React/assets/angular-app.png"
					...
					/>
					<Route
						path="/MyPortfolio-React/myPortfolio"
						element={
							<ProjectInformation
